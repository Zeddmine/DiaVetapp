...
export default function VetPortalPreview({
  ...
  const [activeTab, setActiveTab] = useState<'schedule' | 'rx' | 'stock'>('schedule');
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-12 animate-in fade-in duration-300">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
        ...
        <div className="flex items-center gap-3">
          <div className="text-right hidden sm:block">
            ...
            <p className="text-xs text-emerald-400 font-medium">Cabinet El Biar · {wilaya}</p>
          </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        <div className="p-4 sm:p-5 rounded-2xl bg-slate-950/80 border border-white/10 backdrop-blur-xl">
          <p className="text-xs font-semibold text-slate-400">Consultations du jour</p>
          <p className="text-2xl sm:text-3xl font-black text-white mt-1">14</p>
          <span className="text-[10px] text-emerald-400 font-bold">● 4 terminées</span>
        </div>
        <div className="p-4 sm:p-5 rounded-2xl bg-slate-950/80 border border-white/10 backdrop-blur-xl">
          <p className="text-xs font-semibold text-slate-400">Rappels SMS envoyés</p>
          <p className="text-2xl sm:text-3xl font-black text-cyan-400 mt-1">32</p>
          <span className="text-[10px] text-cyan-300 font-bold">Vaccins & rdv DZ</span>
        </div>
        <div className="p-4 sm:p-5 rounded-2xl bg-slate-950/80 border border-white/10 backdrop-blur-xl">
          <p className="text-xs font-semibold text-slate-400">Recettes estimées (DZD)</p>
          <p className="text-xl sm:text-2xl font-black text-emerald-400 mt-1">48,500 DZD</p>
          <span className="text-[10px] text-slate-400">Moyenne consultation 3,500</span>
        </div>
        <div className="p-4 sm:p-5 rounded-2xl bg-slate-950/80 border border-white/10 backdrop-blur-xl">
          <p className="text-xs font-semibold text-slate-400">Alerte Stock Vaccin</p>
          <p className="text-2xl sm:text-3xl font-black text-amber-400 mt-1">2</p>
          <span className="text-[10px] text-amber-300 font-bold">Rupture imminente</span>
        </div>
      </div>

      {/* Tabs */}
      <div className="flex bg-slate-900/80 p-1.5 rounded-2xl border border-white/10 mb-8 max-w-lg">
        <button
