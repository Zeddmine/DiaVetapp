    ...
    >
      <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-2 sm:gap-4">
        ...
        <div className="flex items-center gap-2 flex-1 min-w-0">
          <span className="shrink-0 font-black text-[10px] uppercase bg-black/30 backdrop-blur-md px-2.5 py-0.5 rounded-full border border-white/20 tracking-wider">
            {content.badge}
          </span>
          <p className="font-medium truncate text-white/95 text-xs sm:text-[13px]">
            {content.message}
          </p>
        </div>
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <a
            ...
            className="hidden sm:inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/15 hover:bg-white/25 text-white font-bold transition-all border border-white/20 hover:scale-105 active:scale-95"
          >
          ...
          <button
            ...
            className="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-white text-slate-950 hover:bg-white/90 font-black transition-all shadow-sm active:scale-95 cursor-pointer"
          >
            <span>{content.actionBtn}</span>
          ...
          <button
            ...
            className="p-1 rounded-full hover:bg-black/20 text-white/80 hover:text-white transition-colors cursor-pointer"
          >
