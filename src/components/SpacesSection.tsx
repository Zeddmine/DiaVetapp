...
import { ArrowRight, Sparkles, CheckCircle2, Stethoscope, HeartHandshake } from 'lucide-react';
    ...
    <section className="py-12 sm:py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
        <span className="text-xs sm:text-sm font-bold uppercase tracking-widest text-cyan-400 bg-cyan-500/10 px-4 py-1.5 rounded-full border border-cyan-500/20">
          Les 2 Pôles Majeurs DiaVet Algérie
        </span>
        <h2 className="text-3xl sm:text-5xl font-black text-white mt-4 tracking-tight">
          Espace Propriétaire & Espace Vétérinaire Pro
        </h2>
        <p className="text-slate-300 text-sm sm:text-base mt-3">
          Une plateforme bilatérale connectant propriétaires d'animaux et docteurs vétérinaires à travers les 58 Wilayas d'Algérie.
        </p>
      </div>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-cyan-500/15 border border-cyan-400/40 text-cyan-300 text-xs font-black uppercase tracking-wider">
              <span>🐾</span>
              <span>Espace Propriétaire (Pass VIP)</span>
            </div>
            ...
            <ul className="mt-6 space-y-2.5 text-xs sm:text-sm text-slate-300">
              <li className="flex items-center gap-2">
                ...
                <span>Carnet de santé intelligent & rappels vaccinaux SMS</span>
              </li>
              <li className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-cyan-400 shrink-0" />
                <span>Prise de rendez-vous en ligne 24/7 dans votre wilaya</span>
              </li>
              <li className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-cyan-400 shrink-0" />
                <span>Urgences, conseils de garde & boîte à idées</span>
              </li>
            </ul>
          </div>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-emerald-500/15 border border-emerald-400/40 text-emerald-300 text-xs font-black uppercase tracking-wider">
              ...
              <span>Espace Vétérinaire (Pass Pro Clinique)</span>
            </div>
            ...
            <ul className="mt-6 space-y-2.5 text-xs sm:text-sm text-slate-300">
              <li className="flex items-center gap-2">
                ...
                <span>Dossiers patients complets & fiches médicales chronologiques</span>
              </li>
              <li className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0" />
                <span>Générateur d'ordonnances homologuées avec QR code & cachet</span>
              </li>
              <li className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0" />
                <span>Module d'imagerie, radiographies & statistiques 58 wilayas</span>
              </li>
            </ul>
          </div>
          ...
          <div className="relative z-10 mt-8 pt-6 border-t border-white/10">
            ...
            >
              ...
              <span>Accéder à la Suite Vétérinaire Pro →</span>
            </button>
          </div>
        </div>
